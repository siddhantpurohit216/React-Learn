...
const {id}=useParams();
// console.log(id)
// console.log(REST_DETAILS_URL + id)
...
console.log("rendered")  
    ...
    async function fetchRestData()
    {
        ...
        // console.log(data);
        const {id, name,city,cloudinaryImageId,costForTwoMessage,cuisines,avgRating,sla}=data;
        setData(data);
        console.log(id , name,city,cloudinaryImageId,costForTwoMessage,cuisines,avgRating);
        }
        catch
        {
